...
function makeGraphs1(error, apiData){
...
//	 timeDim.filter(function(d) {return d.poleid == 1}); 
	...
	var status_tm = timeDim.group().reduceSum(function(d) { if (d.level3 == 1 && d.poleid == 2) {return 20;} else {return 0;};});
	var status_tf = timeDim.group().reduceSum(function(d) { if (d.level4 == 1 && d.poleid == 2) {return 20;} else {return 0;};});	
